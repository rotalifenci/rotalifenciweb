...
const PASSAPAROLA_DATA = [
  ...
  {
    letter: "C",
    question: "Maddelerin işlenerek belirli bir şekil almış haline verilen genel ad (Örn: Masa, bardak).",
    answer: "CİSİM",
    grade: "5. Sınıf",
  ...
  {
    letter: "E",
    question: "Katı bir maddenin dışarıdan ısı alarak sıvı hale geçmesi olayı (Örn: Buzun erimesi).",
    answer: "ERİME",
    grade: "5. Sınıf",
  ...
  {
    letter: "İ",
    question: "Elektrik akımını ya da ısıyı üzerinden kolayca geçiren maddelere verilen ad (Örn: Bakır, demir).",
    answer: "İLETKEN",
    grade: "5-6. Sınıf",
  ...
  {
    letter: "T",
    question: "Maddelerin sıcaklığını derece Celsius (°C) cinsinden ölçen alet.",
    answer: "TERMOMETRE",
    grade: "5. Sınıf",
    category: "Madde ve Isı"
  },
  ...
  {
    letter: "Y",
    question: "Işık ışınlarının parlak ve düzgün bir yüzeye (örn: aynaya) çarpıp yön değiştirerek geri dönmesi olayı.",
    answer: "YANSIMA",
    grade: "5. Sınıf",
